...
<div class="sm:flex sm:items-center sm:justify-between mb-8 space-y-4 sm:space-y-0">
    <div>
        ...
        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
            Ngarkoni skedarin. Lënda do të caktohet automatikisht bazuar te mësuesi.
        </p>
    </div>

    <div class="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto">
        <button type="button" onclick="toggleHelp()" 
            class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-bold text-amber-700 bg-amber-50 border border-amber-200 rounded-xl hover:bg-amber-100 transition-all shadow-sm active:scale-95 focus:outline-none focus:ring-2 focus:ring-amber-500/50">
        ...
        <button type="button" onclick="downloadParentTemplate()" 
            class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-bold text-emerald-700 bg-emerald-50 border border-emerald-200 rounded-xl hover:bg-emerald-100 transition-all shadow-sm active:scale-95 focus:outline-none focus:ring-2 focus:ring-emerald-500/50">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="/E-Shkolla/parents" 
            class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-bold text-slate-700 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 dark:bg-slate-800 dark:text-slate-300 dark:border-white/10 transition-all shadow-sm active:scale-95 focus:outline-none focus:ring-2 focus:ring-slate-500/50">
            Anulo
        </a>
    </div>
</div>
