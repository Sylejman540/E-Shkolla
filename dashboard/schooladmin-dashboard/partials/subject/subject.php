...
<div id="subjectTableContainer" class="px-4 sm:px-6 lg:px-8 py-8">
    <div class="sm:flex sm:items-center justify-between mb-8">
        ...
        <div class="mt-4 sm:mt-0">
            <a href="/E-Shkolla/teachers?open_form=1" class="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 transition-all active:scale-95">
