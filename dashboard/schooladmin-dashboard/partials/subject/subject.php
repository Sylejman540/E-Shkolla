  ...
  <div class="xl:pl-18">
    <div class="px-4 py-10 sm:px-6 lg:px-8 lg:py-6 relative">
        ...
        <div class="sm:flex sm:items-center">
            ...
            <h1 class="text-base font-semibold text-gray-900 dark:text-white">Lëndët</h1>
            <p class="mt-2 text-sm text-gray-700 dark:text-gray-300">Lista e të gjithë lëndëve në sistemin tuaj, duke përfshirë emrin e lëndës dhe statusin e tyre.</p>
            </div>
            ...
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-white">Kodi</th>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-white/10">
                    <tr>
                        ...
                        <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400"><?= htmlspecialchars($row['code']) ?></td>
