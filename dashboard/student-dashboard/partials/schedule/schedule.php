    ...
    <div class="px-4 py-10 sm:px-6 lg:px-8 lg:py-6">
        ...
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-base font-semibold text-gray-900 dark:text-white">Orari javor</h1>
            </div>
        </div>
        ...
        <?php if (!empty($classes)): ?>
            ...
            <tr>
                ...
                <td class="px-3 py-4 text-sm whitespace-nowrap text-right">
                    <button type="button" class="text-indigo-600 hover:text-indigo-900" onclick="toggleSchedule(<?= (int)$row['id'] ?>)">
                        Shiko orarin
                    </button>
                </td>
            </tr>
